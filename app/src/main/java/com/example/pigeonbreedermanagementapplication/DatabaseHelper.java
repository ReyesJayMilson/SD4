...
//Create Table for Symptoms
    ...
    public String getMipmapAbsolutePath(String resourceName) {
        Resources res = context.getResources();
        String packageName = context.getPackageName();
        int resId = res.getIdentifier(resourceName, "mipmap", packageName);
        String absolutePath = res.getResourceName(resId);
